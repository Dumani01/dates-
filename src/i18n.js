  ...
  resources: {
    es: {
      translation: {
        ...
        dateLabel: 'Fecha de la cita', dateTitle: 'Elijamos el día', dateCopy: 'Selecciona la fecha que te gustaría para nuestra salida.', back: 'Atrás', next: 'Siguiente →',
    ...
    en: {
      translation: {
        ...
        dateLabel: 'Date of our date', dateTitle: 'Let’s choose the day', dateCopy: 'Choose the date you would like for our outing.', back: 'Back', next: 'Next →',
